...
<body class="bg-dark">
    ...
    if (isset($_POST['submit'])) {
        ...
        include '../../connect.php';
        $sql = "INSERT INTO creator_lists (creator_name, creator_email) VALUES ('$name', '$email');";
            ...
            <main class="col-10 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-labels="breadcrumb">
                    <ol class="breadcrumb brdcrumb fs-4">
                        <li class="breadcrumb-item fw-bold"><a class="text-light" href="/finalProject/admin/authors/index.php">Author</a></li>
                        <li class="breadcrumb-item" aria-current="page">Add New Author</li>
                    </ol>
                </nav>
                <div class="row mt-5">
                        ...
                        <div class="card-body">
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Name of the Author" required autocomplete="off">
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label">Contact Person</label>
                                    <input type="email" class="form-control" id="email" name="email" placeholder="author@email.com" required autocomplete="off">
                                </div>
