...
<body class="bg-dark">
    ...
    $sql = "SELECT DISTINCT creator_lists.creator_name FROM creator_lists INNER JOIN news_details ON creator_lists.creator_id=news_details.creator_id";
    $checks = $conn->query($sql);
    ?>
            ...
            <main class="col-10 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-labels="breadcrumb">
                    <ol class="breadcrumb brdcrumb fs-4">
                        <li class="breadcrumb-item fw-bold"><a class="text-light" href="#">Authors</a></li>
                        <li class="breadcrumb-item" aria-current="page">Overview</li>
                    </ol>
                </nav>
                <div class="row mt-5">
                    <div class="card bg-light text-dark ms-2" style="width: 90% !important">
                        <h5 class="card-header text-center text-dark">Authors the Executive News</h5>
                        <div class="card-body">
                            <a href="create.php" class="btn btn-block btn-success"><i class="fa-solid fa-plus me-3"></i>Add Author</a>
                                            ...
                                            echo '
                                                <tr>
                                                    ...
                                                    <td class="text-center align-items-center">
                                                        <a href="show.php?id=' . $data['creator_id'] . '" class="btn btn-sm btn-primary">View</a>
                                                        <a href="edit.php?id=' . $data['creator_id'] . '" class="btn btn-sm btn-warning">Edit</a>
                                                        <a onclick="return confirm(`Confirm delete action?`)" href="delete.php?id=' . $data['creator_id'] . '" class="';
                                            foreach ($checks as $key => $data2) {
                                                if ($data2['creator_name'] == $data['creator_name']) {
                                                    echo 'disabled ';
                                                    break;
                                                }
                                            };
                                            echo        'btn btn-sm btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                            ';
                                        }
