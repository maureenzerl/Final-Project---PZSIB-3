...
<body class="bg-dark">
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM creator_lists WHERE creator_id='$id'";
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE creator_lists SET creator_name ='$name', creator_email ='$email',  total_news = '$total' WHERE creator_id = $id;";
        $datas = $conn->query($sql);
            ...
            <main class="col-10 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-labels="breadcrumb">
                    <ol class="breadcrumb brdcrumb fs-4">
                        <li class="breadcrumb-item fw-bold"><a class="text-light" href="/finalProject/admin/authors/index.php">Authors</a></li>
                        <li class="breadcrumb-item" aria-current="page">Edit Author</li>
                    </ol>
                </nav>
                <div class="row mt-5">
                        ...
                        <div class="card-body">
                            <form action="<?php echo $_SERVER['PHP_SELF'] . "?id=" . $id ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Name of the Author" required value="<?php echo $name ?>" autocomplete="off">
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label">Contact Person</label>
                                    <input type="email" class="form-control" id="email" name="email" placeholder="author@email.com" required value="<?php echo $email ?>" autocomplete="off">
                                </div>
