...
<body class="bg-dark">
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM category_lists WHERE category_id='$id'";
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE category_lists SET category_name ='$name', description = '$desc' WHERE category_id = $id;";
        $datas = $conn->query($sql);
                        ...
                        <div class="card-body">
                            <form action="<?php echo $_SERVER['PHP_SELF'] . "?id=" . $id ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Name of the News Category" required value="<?php echo $name ?>" autocomplete="off">
                                </div>
                                <div class="mb-3">
                                    <label for="desc" class="form-label">Description</label>
                                    <input type="text" class="form-control" id="desc" name="desc" placeholder="Description of the Category" required value="<?php echo $desc ?>" autocomplete="off">
                                </div>
