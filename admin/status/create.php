...
<body class="bg-dark">
    ...
    if (isset($_POST['submit'])) {
        ...
        include '../../connect.php';
        $sql = "INSERT INTO news_status (status_name) VALUES ('$status');";
            ...
            <main class="col-10 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-labels="breadcrumb">
                    <ol class="breadcrumb brdcrumb fs-4">
                        <li class="breadcrumb-item fw-bold"><a class="text-light" href="/finalProject/admin/categories/index.php">Status</a></li>
                        ...
                        <div class="card-body">
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="status" name="status" placeholder="News Status" required autocomplete="off">
                                </div>
