...
<body class="bg-dark">
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM news_status WHERE status_id='$id'";
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE news_status SET status_name ='$status' WHERE status_id = $id;";
        $datas = $conn->query($sql);
            ...
            <main class="col-10 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-labels="breadcrumb">
                    <ol class="breadcrumb brdcrumb fs-4">
                        <li class="breadcrumb-item fw-bold"><a class="text-light" href="/finalProject/admin/status/index.php">Status</a></li>
                        <li class="breadcrumb-item" aria-current="page">Edit News Status</li>
                    </ol>
                </nav>
                <div class="row mt-5">
                        ...
                        <div class="card-body">
                            <form action="<?php echo $_SERVER['PHP_SELF'] . "?id=" . $id ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="status" name="status" placeholder="News Status" required value="<?php echo $status ?>" autocomplete="off">
                                </div>
