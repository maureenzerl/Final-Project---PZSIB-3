...
<body class="bg-dark">
    ...
    $sql = "SELECT DISTINCT news_status.status_name FROM news_status INNER JOIN news_details ON news_status.status_id=news_details.status_id";
            ...
            <main class="col-10 ms-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-labels="breadcrumb">
                    <ol class="breadcrumb brdcrumb fs-4">
                        <li class="breadcrumb-item fw-bold"><a class="text-light" href="#">Status</a></li>
                        <li class="breadcrumb-item" aria-current="page">Overview</li>
                    </ol>
                </nav>
                <div class="row mt-5">
                    <div class="card bg-light text-dark ms-2" style="width: 90% !important">
                        <h5 class="card-header text-center text-dark">Status of the News</h5>
                        <div class="card-body">
                            <a href="create.php" class="btn btn-block btn-success"><i class="fa-solid fa-plus me-3"></i>Add Status</a>
                                            ...
                                            echo '
                                                <tr>
                                                    ...
                                                    <td class="text-center align-items-center">
                                                        <a href="show.php?id=' . $data['status_id'] . '" class="btn btn-sm btn-primary">View</a>
                                                        <a href="edit.php?id=' . $data['status_id'] . '" class="btn btn-sm btn-warning">Edit</a>
                                                        <a onclick="return confirm(`Confirm delete action?`)" href="delete.php?id=' . $data['status_id'] . '" class="';
                                            foreach ($checks as $key => $data2) {
                                                if ($data2['status_name'] == $data['status_name']) {
                                                    echo 'disabled ';
                                                    break;
                                                }
                                            };
